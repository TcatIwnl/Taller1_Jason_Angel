    ...
    public static void registrarActividad(String usuarioActual, Scanner lector) {
        ...
        do {
            ...
            if (!esFechaValida(fecha)) {
                System.out.println("Formato invalido. Use dd/mm/yyyy y recuerde que febrero llega hasta 28.");
            }
                ...
                switch (tipoMod) {
                    ...
                    case 2:
                        ...
                        do {
                            ...
                            try {
                                nuevasHoras = Integer.parseInt(lector.nextLine());
                    ...
                    case 3:
                        ...
                        do {
                            ...
                            nuevaActividad = lector.nextLine();
                            ...
                            if (nuevaActividad.trim().equals("")) {
                                System.out.println("La actividad no puede estar vacia.");
                            }

                        } while (!nuevaActividad.equals("0") && nuevaActividad.trim().equals(""));

                        if (!nuevaActividad.equals("0")) {
                            regActividad[indiceReal] = nuevaActividad;
                            guardarCambios(1);
                            System.out.println("Actividad modificada con exito!");
                            tipoMod = 0;
                        }
    ...
    public static void eliminarActividad(String usuarioActual, Scanner lector) {
        ...
        if (opcionElegida > 0 && opcionElegida <= cantidadRegistros) {
            ...
            if (confirmacion == 1) {
                ...
                regUsuario[cantRegistros] = null;
                regFecha[cantRegistros] = null;
                regHoras[cantRegistros] = 0;
                regActividad[cantRegistros] = null;
